...
async def pm_text(bot, message):
    ...
    await message.reply_text("𝖯𝖬 𝖿𝗂𝗅𝗍𝖾𝗋 𝗂𝗌 𝗇𝗈𝗍 𝖺𝗏𝖺𝗂𝗅𝖺𝖻𝗅𝖾... 𝖨𝖿 𝗒𝗈𝗎 𝗐𝖺𝗇𝗍 𝗆𝗈𝗏𝗂𝖾 𝗈𝗋 𝗌𝖾𝗋𝗂𝖾𝗌 𝖱𝖾𝗊𝗎𝖾𝗌𝗍 @Cine_Paradise 𝖮𝗋 𝖴𝗌𝖾 𝖻𝗈𝗍 𝗂𝗇𝗅𝗂𝗇𝖾 𝖻𝗎𝗍𝗍𝗈𝗇... 𝖠𝗇𝗒 𝖽𝗈𝗎𝖻𝗍𝗌 𝖠𝗌𝗄 @Dev_Rbot")
